...
@Component({
  selector: 'app-cml-question',
  templateUrl: './cml-question.component.html',
  styleUrls: ['./cml-question.component.css']
})
export class CmlQuestionComponent implements OnInit {
  ...
  submitSubcategories(form: NgForm) {
    ...
    this.qandaArray = [];
    theReturnedJSON = this.dynamoDBservice.getAllMLItems(this.checked).subscribe( qandas => {
