...
const serviceGetAllArch20Items = 'https://ts44kzo19l.execute-api.us-east-1.amazonaws.com/dev/getAllQandAs20Arch';
...
export class DynamoDbserviceService {
  ...
  getAllArch20Items(subcategories) {
    let resultData;
    let url = serviceGetAllArch20Items + '/';
    // add parameters to url
    // url = url + '/S3/CloudFront/IAM';
    subcategories.forEach(function (subcategoryItem) {
      /*url = url + '/' + encodeURI(subcategoryItem);*/
