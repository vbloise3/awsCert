...
@Component({
  selector: 'app-ca220-question',
  templateUrl: './ca220-question.component.html',
  styleUrls: ['./ca220-question.component.css']
})
export class Ca220QuestionComponent implements OnInit {
  options: FormGroup;
  ...
  submitSubcategories(form: NgForm) {
    ...
    this.qandaArray = [];
    theReturnedJSON = this.dynamoDBservice.getAllArch20Items(this.checked).subscribe( qandas => {
